...
/**
 * @author dengteng
 * @title: ProgressreportUpdateDTO
 * @projectName rdexpense-back
 * @description: 项目进展报告修改类
 * @date 2021/11/27
 */
@Data
@ApiModel(value = "研发项目进展报告修改类")
public class ProgressreportUpdateDTO extends OrganizationDto implements Serializable {
