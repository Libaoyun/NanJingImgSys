...
import com.rdexpense.manager.dto.imgSys.Page.PageParam;
import com.rdexpense.manager.dto.imgSys.PartOfForm;
import com.rdexpense.manager.dto.imgSys.Patient;
import com.rdexpense.manager.dto.imgSys.form.PartOfFormRequest;
import com.rdexpense.manager.dto.imgSys.form.RegisterList;
...
//    @ApiImplicitParam(name = "orgId", value = "部门ID", required = true, dataType = "String")
    public ResponseEntity<List<PartOfForm>> getStandardBodyPart() {
        PageData pd = this.getParams();
        try {
