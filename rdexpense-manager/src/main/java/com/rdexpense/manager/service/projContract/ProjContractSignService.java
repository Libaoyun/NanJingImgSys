...
public interface ProjContractSignService {
    ...
    int getProjLeaderInfoParams(Map<String, String> params, PageData projContrPd);
    /**
     * 课题的负责人信息
     * @param params
     * @param projContrPd
    ...
    void fillConsigneeUnit2Table(XWPFTable xwpfTbl, PageData projContrPd) throws IOException, XmlException;
