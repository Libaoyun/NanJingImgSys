...
public interface AttendanceService {
   ...
   PageData getApplyDetail(PageData pd);
     ...
     * @throws Exception
     */
    List<PageData> uploadAttendance(MultipartFile file, PageData pd) throws Exception;
     ...
     * @throws Exception
     */
    List<PageData> uploadSalary(MultipartFile file, PageData pd) throws Exception;
     ...
     * @throws Exception
     */
    List<PageData> generateShare(MultipartFile file, PageData pd) throws Exception;
