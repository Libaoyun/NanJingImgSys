...
public class ExcelUtil {
     ...
     * @return
     */
    public static HSSFCellStyle setCellLeft(HSSFWorkbook wb, HSSFSheet sheet) {
        // 字段样式
        HSSFCellStyle cellStyle = wb.createCellStyle();
        cellStyle.setAlignment(HSSFCellStyle.ALIGN_LEFT);// 水平居中
        cellStyle.setVerticalAlignment(CellStyle.VERTICAL_CENTER);// 垂直居中
     ...
     * @return
     */
    public static HSSFCellStyle setCellLeftIndentionOne(HSSFWorkbook wb, HSSFSheet sheet) {
        // 字段样式
        HSSFCellStyle cellStyle = wb.createCellStyle();
     ...
     * @return
     */
    public static HSSFCellStyle setCellLeftIndentionTwo(HSSFWorkbook wb, HSSFSheet sheet) {
        // 字段样式
        HSSFCellStyle cellStyle = wb.createCellStyle();
