...
public enum ConstantMsgUtil {
    ...
    ERR_ENGINEERING_TREE_EXCEPTION(1000020,"获取工程树信息异常"),
    ERR_REMOTE_TOKEN_EXCEPTION(1000017,"获取redis中人事、机构等的token异常"),
    ERR_REMOTE_BLANK_TOKEN_EXCEPTION(1000003,"获取redis中人事、机构等的token为空"),
    ERR_OUT_SYSTEM_EXCEPTION(1000018,"获取外部接口异常"),
    ...
    WAN_EXISTING_CODE(30036, "{0}编码数据已存在");
