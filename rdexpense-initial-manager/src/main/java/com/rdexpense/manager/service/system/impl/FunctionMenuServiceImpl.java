...
public class FunctionMenuServiceImpl implements FunctionMenuService {
     ...
     */
    @Override
    public List<FunctionMenuButtonDTO> queryRoutingMenuTree(String token,PageData pageData) {
...
//        pageData.put("organizationId","1");
        pageData.put("userIdList",userIdList);
        //查询菜单权限,和授权按钮
        List<PageData> authorMenuList = (List<PageData>) baseDao.findForList("RouteMenuMapper.queryMenuButton", pageData);
