...
@Slf4j
@Service
public class ImgMainServiceImpl implements ImgMainService {
    @Autowired
    ...
    @Override
    public List<PageData> queryByDeviceCode(PageData pd) {
        List<PageData> imgMainList =
                (List<PageData>) baseDao.findForList("PhotoMainMapper.queryByDeviceCode", pd);
...
//        List<PageData> imgPropertyExList =
//                (List<PageData>) baseDao.findForList("PhotoPropertyExMapper.queryByImgSerialNumList", imgSnList);
//
