...
import com.imgSys.dto.DiagnosticItem;
import com.imgSys.service.DiagnosticItemService;
...
//    @ApiImplicitParam(name = "orgId", value = "部门ID", required = true, dataType = "String")
    public ResponseEntity<List<DiagnosticItem>> getAllDiagnosticItem() {
        PageData pd = this.getParams();
        try {
            List<PageData> dataList = diagnosticItemService.getAllDiagnosticItem("0", pd);
