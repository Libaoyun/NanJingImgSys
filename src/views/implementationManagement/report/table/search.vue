    ...
    <div>
      ...
      >
        <el-form-item label="用户编号" prop="userCode">
          <el-input
            v-model.trim="searchParams.userCode"
            placeholder="请输入用户编号"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="手机号码" prop="mobilePhone">
          <el-input
            v-model.trim="searchParams.mobilePhone"
            placeholder="请输入手机号码"
          ></el-input>
        </el-form-item>
        <el-form-item label="所属部门" prop="departmentName">
          <el-input
            v-model.trim="searchParams.departmentName"
            placeholder="请输入所属部门"
          ></el-input>
        </el-form-item>
        <el-form-item label="所属职务" prop="postName">
          <el-input
            v-model.trim="searchParams.postName"
            placeholder="请输入所属职务"
          ></el-input>
        </el-form-item>
        <el-form-item label="创建人" prop="createUser">
          <el-input
            v-model.trim="searchParams.createUser"
            placeholder="请输入创建人"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="更新人" prop="updateUser">
          <el-input
            v-model.trim="searchParams.updateUser"
            placeholder="请输入更新人"
          ></el-input>
        </el-form-item>
