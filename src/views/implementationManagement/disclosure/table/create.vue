...
import tableDialog from '@/views/implementationManagement/disclosure/alert/alertStateX/create.vue';
...
export default class extends tableMixin {
  ...
  getBaseInfo() {
    return {
      orgNumber: this.$store.getters.currentOrganization?.organizationId,
